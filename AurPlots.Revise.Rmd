...
select3 = c("ANAPC11", "CDC20", "ANAPC10", "CDC37", "CDC34", "CD1C", "CCR7")
select4 = c("ANAPC11","CDC34", "CD1C", "CCR7")
...
**Fig 7. The gene set of antigen receptor-mediated signaling pathway is down regulated in metastatic to primary, meaning that this could cause more issues for the immune system to fight and recognize the tumor and contribute to the progression of the metastatic tumors..**
